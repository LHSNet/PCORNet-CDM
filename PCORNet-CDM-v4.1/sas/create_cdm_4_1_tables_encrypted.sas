...
VARIABLES:
 The program uses the following four variables that need to be set by the user.
...
%let dpath=M:\pcori\pcori_test_encrypted;    /* Directory where encrypted SAS files will be created. */ 
