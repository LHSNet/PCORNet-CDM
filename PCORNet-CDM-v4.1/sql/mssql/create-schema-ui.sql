...
CREATE TABLE pcori_cdmv4_1.procedures (
    proceduresid UNIQUEIDENTIFIER NOT NULL,
    patid        UNIQUEIDENTIFIER NOT NULL,
    encounterid  UNIQUEIDENTIFIER NOT NULL,
    enc_type     CHAR(2),
    admit_date   DATE,
...
-- vitalid should not be null, however when loading
-- at michigan this may be initially null and then
-- bulk updated
CREATE TABLE pcori_cdmv4_1.vital (
    vitalid          UNIQUEIDENTIFIER,
    patid            UNIQUEIDENTIFIER NOT NULL,
...
CREATE TABLE pcori_cdmv4_1.dispensing (
    dispensingid                 UNIQUEIDENTIFIER NOT NULL,
    patid                        UNIQUEIDENTIFIER NOT NULL,
    prescribingid                UNIQUEIDENTIFIER,
...
CREATE TABLE pcori_cdmv4_1.lab_result_cm (
    lab_result_cm_id   UNIQUEIDENTIFIER NOT NULL,
    patid              UNIQUEIDENTIFIER NOT NULL,
    encounterid        UNIQUEIDENTIFIER,
    lab_name           VARCHAR(10),
...
CREATE TABLE pcori_cdmv4_1.prescribing (
    prescribingid            UNIQUEIDENTIFIER NOT NULL,
    patid                    UNIQUEIDENTIFIER NOT NULL,
    encounterid              UNIQUEIDENTIFIER,
    rx_providerid            UNIQUEIDENTIFIER,
    rx_order_date            DATE,
...
CREATE TABLE pcori_cdmv4_1.med_admin (
    ...
    encounterid                     UNIQUEIDENTIFIER,
    prescribingid                   UNIQUEIDENTIFIER,
    medadmin_providerid             UNIQUEIDENTIFIER,
...
CREATE TABLE pcori_cdmv4_1.obs_clin (
    ...
    patid                    UNIQUEIDENTIFIER NOT NULL,
    encounterid              UNIQUEIDENTIFIER,
    obsclin_providerid       UNIQUEIDENTIFIER,
...
CREATE TABLE pcori_cdmv4_1.obs_gen (
    ...
    patid                    UNIQUEIDENTIFIER NOT NULL,
    encounterid              UNIQUEIDENTIFIER,
    obsgen_providerid        UNIQUEIDENTIFIER,
