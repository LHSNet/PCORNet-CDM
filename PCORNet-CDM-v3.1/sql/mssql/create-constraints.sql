...
ALTER TABLE pcori_cdmv3_1.enrollment ADD CONSTRAINT fk_enrollment_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
...
ALTER TABLE pcori_cdmv3_1.encounter ADD CONSTRAINT fk_encounter_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
...
ALTER TABLE pcori_cdmv3_1.diagnosis ADD CONSTRAINT fk_diagnosis_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
ALTER TABLE pcori_cdmv3_1.diagnosis ADD CONSTRAINT fk_diagnosis_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3_1.encounter (encounterid);
...
ALTER TABLE pcori_cdmv3_1.procedures ADD CONSTRAINT fk_procedures_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
ALTER TABLE pcori_cdmv3_1.procedures ADD CONSTRAINT fk_procedures_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3_1.encounter (encounterid);
...
ALTER TABLE pcori_cdmv3_1.vital ADD CONSTRAINT fk_vital_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
ALTER TABLE pcori_cdmv3_1.vital ADD CONSTRAINT fk_vital_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3_1.encounter (encounterid);
...
ALTER TABLE pcori_cdmv3_1.prescribing ADD CONSTRAINT fk_prescribing_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
ALTER TABLE pcori_cdmv3_1.prescribing ADD CONSTRAINT fk_prescribing_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3_1.encounter (encounterid);
...
ALTER TABLE pcori_cdmv3_1.dispensing ADD CONSTRAINT fk_dispensing_patid FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
ALTER TABLE pcori_cdmv3_1.dispensing ADD CONSTRAINT fk_dispensing_prescribing FOREIGN KEY (prescribingid) REFERENCES pcori_cdmv3_1.prescribing (prescribingid);

ALTER TABLE pcori_cdmv3_1.lab_result_cm ADD CONSTRAINT pk_lab_result_cm PRIMARY KEY (lab_result_cm_id);
ALTER TABLE pcori_cdmv3_1.lab_result_cm ADD CONSTRAINT fk_lab_result_cm_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
ALTER TABLE pcori_cdmv3_1.lab_result_cm ADD CONSTRAINT fk_lab_result_cm_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3_1.encounter (encounterid);
...
ALTER TABLE pcori_cdmv3_1.condition ADD CONSTRAINT fk_condition_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
ALTER TABLE pcori_cdmv3_1.condition ADD CONSTRAINT fk_condition_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3_1.encounter (encounterid);
...
ALTER TABLE pcori_cdmv3_1.pro_cm ADD CONSTRAINT fk_pro_cm_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
ALTER TABLE pcori_cdmv3_1.pro_cm ADD CONSTRAINT fk_pro_cm_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3_1.encounter (encounterid);
...
ALTER TABLE pcori_cdmv3_1.pcornet_trial ADD CONSTRAINT fk_pcornet_trial_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);

ALTER TABLE pcori_cdmv3_1.death ADD CONSTRAINT pk_death PRIMARY KEY (patid, death_date, death_source);
ALTER TABLE pcori_cdmv3_1.death ADD CONSTRAINT fk_death_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
...
ALTER TABLE pcori_cdmv3_1.death_cause ADD CONSTRAINT fk_death_cause_demographic FOREIGN KEY (patid) REFERENCES pcori_cdmv3_1.demographic (patid);
