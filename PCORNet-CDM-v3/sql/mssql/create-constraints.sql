...
ALTER TABLE pcori_cdmv3.encounter ADD CONSTRAINT ck_encounter_enc_type CHECK (enc_type IN ('AV', 'ED', 'EI', 'IP', 'IS', 'OA', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.encounter ADD CONSTRAINT ck_encounter_discharge_disposition CHECK (discharge_disposition IN ('A', 'E', 'NI', 'UN', 'OT'));
...
ALTER TABLE pcori_cdmv3.diagnosis ADD CONSTRAINT fk_diagnosis_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3.encounter (encounterid);
ALTER TABLE pcori_cdmv3.diagnosis ADD CONSTRAINT ck_diagnosis_enc_type CHECK (enc_type IN ('AV', 'ED', 'EI', 'IP', 'IS', 'OA', 'NI', 'UN', 'OT'));
...
ALTER TABLE pcori_cdmv3.procedures ADD CONSTRAINT fk_procedures_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3.encounter (encounterid);
...
ALTER TABLE pcori_cdmv3.vital ADD CONSTRAINT fk_vital_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3.encounter (encounterid);
ALTER TABLE pcori_cdmv3.vital ADD CONSTRAINT ck_vital_source CHECK (vital_source IN ('PR', 'PD', 'HC', 'HD', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.vital ADD CONSTRAINT ck_vital_bp_position CHECK (bp_position IN ('01', '02', '03', 'NI', 'UN', 'OT'));
...
ALTER TABLE pcori_cdmv3.lab_result_cm ADD CONSTRAINT fk_lab_result_cm_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3.encounter (encounterid);
ALTER TABLE pcori_cdmv3.lab_result_cm ADD CONSTRAINT ck_lab_result_cm_lab_name CHECK (lab_name IN ('A1C', 'CK', 'CK_MB', 'CK_MBI', 'CREATININE', 'HGB', 'LDL', 'INR', 'TROP_I', 'TROP_T_QL', 'TROP_T_QN'));
ALTER TABLE pcori_cdmv3.lab_result_cm ADD CONSTRAINT ck_lab_result_cm_specimen_source CHECK (specimen_source IN ('BLOOD', 'CSF', 'PLASMA', 'PPP', 'SERUM', 'SR_PLS', 'URINE', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.lab_result_cm ADD CONSTRAINT ck_lab_result_cm_priority CHECK (priority IN ('E', 'R', 'S', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.lab_result_cm ADD CONSTRAINT ck_lab_result_cm_result_loc CHECK (result_loc IN ('L', 'P', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.lab_result_cm ADD CONSTRAINT ck_lab_result_cm_lab_px_type CHECK (lab_px_type IN ('09', '10', '11', 'C2', 'C3', 'C4', 'H3', 'HC', 'LC', 'ND', 'RE', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.lab_result_cm ADD CONSTRAINT ck_lab_result_cm_result_qual CHECK (result_qual IN ('BORDERLINE', 'POSITIVE', 'NEGATIVE', 'UNDETERMINED', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.lab_result_cm ADD CONSTRAINT ck_lab_result_cm_result_modifier CHECK (result_modifier IN ('EQ', 'GE', 'GT', 'LE', 'LT', 'TX', 'NI', 'UN', 'OT'));
...
ALTER TABLE pcori_cdmv3.condition ADD CONSTRAINT fk_condition_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3.encounter (encounterid);
...
ALTER TABLE pcori_cdmv3.pro_cm ADD CONSTRAINT fk_pro_cm_encounter FOREIGN KEY (encounterid) REFERENCES pcori_cdmv3.encounter (encounterid);
ALTER TABLE pcori_cdmv3.pro_cm ADD CONSTRAINT ck_pro_cm_pro_item CHECK (pro_item BETWEEN 'PN_0001' AND 'PN_0021');
...
ALTER TABLE pcori_cdmv3.death_cause ADD CONSTRAINT ck_death_cause_code CHECK (death_cause_code IN ('09', '10', 'NI', 'UN', 'OT'));
...
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_datamart_claims CHECK (datamart_claims IN ('01', '02', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_datamart_ehr CHECK (datamart_ehr IN ('01', '02', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_birth_date_mgmt CHECK (birth_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_enr_start_date_mgmt CHECK (enr_start_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_enr_end_date_mgmt CHECK (enr_end_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_admit_date_mgmt CHECK (admit_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_discharge_date_mgmt CHECK (discharge_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_px_date_mgmt CHECK (px_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_rx_order_date_mgmt CHECK (rx_order_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_rx_start_date_mgmt CHECK (rx_start_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_rx_end_date_mgmt CHECK (rx_end_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_dispense_date_mgmt CHECK (dispense_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_lab_order_date_mgmt CHECK (lab_order_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_specimen_date_mgmt CHECK (specimen_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_result_date_mgmt CHECK (result_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_measure_date_mgmt CHECK (measure_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
ALTER TABLE pcori_cdmv3.harvest ADD CONSTRAINT ck_harvest_onset_date_mgmt CHECK (onset_date_mgmt IN ('01', '02', '03', '04', 'NI', 'UN', 'OT'));
